...
UIType getPropertyType(UIProperty property)
{
    switch (property) {
        ...
        case UIProperty::tabTitle:
            return UIType::string;
        case UIProperty::selectedIndex:
            return UIType::integer;
        case UIProperty::columns:
            return UIType::sizelist;
        case UIProperty::rows:
            return UIType::sizelist;
        case UIProperty::left:
            return UIType::integer;
        case UIProperty::top:
            return UIType::integer;
        case UIProperty::enabled:
            return UIType::boolean;
        case UIProperty::imageScaling:
            return UIType::enumeration;
        case UIProperty::image:
            return UIType::resource;
        case UIProperty::bindingContext:
            return UIType::object;
        case UIProperty::childSource:
            return UIType::objectlist;
        case UIProperty::childTemplate:
            return UIType::resource;
        case UIProperty::hitTestVisible:
            return UIType::boolean;
        case UIProperty::onClick:
            return UIType::callback;
        case UIProperty::orientation:
            return UIType::enumeration;
    }
...
std::string to_string(UIWidget widget)
{
    switch (widget) {
        ...
        case UIWidget::label:
            return "Label";
        case UIWidget::combobox:
            return "ComboBox";
        case UIWidget::treeview:
            return "TreeView";
        case UIWidget::listbox:
            return "ListBox";
        case UIWidget::picture:
            return "Picture";
        case UIWidget::textbox:
            return "TextBox";
        case UIWidget::checkbox:
            return "CheckBox";
        case UIWidget::radiobutton:
            return "RadioButton";
        case UIWidget::scrollview:
            return "ScrollView";
        case UIWidget::scrollbar:
            return "ScrollBar";
        case UIWidget::slider:
            return "Slider";
        case UIWidget::progressbar:
            return "ProgressBar";
        case UIWidget::spinedit:
            return "SpinEdit";
        case UIWidget::separator:
            return "Separator";
        case UIWidget::spacer:
            return "Spacer";
        case UIWidget::panel:
            return "Panel";
        case UIWidget::container:
            return "Container";
        case UIWidget::tab_layout:
            return "TabLayout";
        case UIWidget::canvas_layout:
            return "CanvasLayout";
        case UIWidget::flow_layout:
            return "FlowLayout";
        case UIWidget::grid_layout:
            return "GridLayout";
        case UIWidget::dock_layout:
            return "DockLayout";
        case UIWidget::stack_layout:
            return "StackLayout";
    }
