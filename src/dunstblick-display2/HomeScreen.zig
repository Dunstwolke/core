...
pub fn render(self: Self, target: Framebuffer) void {
    ...
    // comptime {
    //     @compileLog("Icon sizes:");
    //     for (icon_list) |icon, i| {
    //         @compileLog(i, icon.len);
    //     }
    // }
...
// pub fn main() !void {
//     try std.fs.cwd().writeFile("lib/tvg/examples/menu.tvg", icons.app_menu);
// }
