...
std::string to_string(UIProperty property)
{
	switch(property)
	{
		...
		case UIProperty::onClick: return "on-click";
		case UIProperty::orientation: return "orientation";
		case UIProperty::name: return "widget-name";
	}
...
std::string to_string(UIWidget widget)
{
	switch(widget)
	{
		...
		case UIWidget::container: return "Container";
